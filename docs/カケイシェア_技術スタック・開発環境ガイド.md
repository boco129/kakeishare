...
| **認証** | NextAuth.js v4 | Credentials認証から始められる。Next.js 16との互換性のためv4を採用 |
| **AI連携** | Anthropic SDK (TypeScript) | 公式SDK、型安全 |
| **グラフ** | Recharts | React用チャートライブラリ、shadcn/uiと相性良い |
| **通知** | LINE Messaging API | Webhook対応、日本でのリーチ最大 |
